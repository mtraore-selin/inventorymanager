                    ...
                    >
                      ...
                      >
                        <circle
                          ...
                          stroke="#516fc9"
                          strokeWidth="5"
                          strokeDasharray={`${productGenderP[1].percentage} ${
                            100 - productGenderP[1].percentage
                          }`}
                          strokeDashoffset="0"
                        ></circle>
                        <circle
                          ...
                          stroke="#f07fce"
                          strokeWidth="5"
                          strokeDasharray={`${productGenderP[0].percentage} ${
                            100 - productGenderP[0].percentage
                          }`}
                        ...
                        <circle
                          ...
                          stroke="#fcbc53"
                          strokeWidth="5"
                          strokeDasharray={`${productGenderP[2].percentage} ${
                            100 - productGenderP[2].percentage
                          }`}
                          strokeDashoffset={
                            (productGenderP[1].percentage +
                              productGenderP[0].percentage) *
                            -1
                          }
                        ></circle>
                      </svg>
                      ...
                      <div
                        style={{ fontSize: "smaller", position: "absolute" }}
                      >
                        <div>
                          <div
                            className="me-1"
                          ...
                          <span>{productGenderP[1].count}</span>
                        </div>
                        <div>
                          <div
                            className="me-1"
                            style={{
                              backgroundColor: "#f07fce",
                              width: "10px",
                              height: "10px",
                              display: "inline-block",
                              borderRadius: "3px",
                          ...
                          <span>{productGenderP[0].count}</span>
                        </div>
                        <div>
                          <div
                            className="me-1"
                          ...
                          <span>{productGenderP[2].count}</span>
                        </div>
                      </div>
                    </div>
                  )}
