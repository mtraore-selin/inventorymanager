...
export default function Feature({ reportStats }) {
  ...
  o2 =
    reportStats[1].previous_month == null ? 0 : reportStats[1].previous_month;
  e1 = reportStats[2].current_month == null ? 0 : reportStats[2].current_month;
  e2 =
    reportStats[2].previous_month == null ? 0 : reportStats[2].previous_month;
    ...
    <div className="featured">
        ...
        >
          <div className="d-flex gap-2">
            ...
            <Link to="/employees" className="link">
              <span className="text-hover-primary">Employees:</span>
            </Link>
          ...
          <div className="d-flex gap-2 my-1">
            ...
            <Link to="/customers" className="link">
              <span className="text-hover-primary">Customers:</span>
            </Link>
          ...
          <div className="d-flex gap-2">
            ...
            <Link to="/suppliers" className="link">
              <span className="text-hover-primary">Suppliers:</span>
            </Link>
      ...
      <div className="featuredItem">
        ...
        <div className="featuredMoneyContainer">
          ...
          <div
            ...
            style={{ color: porder >= 0 ? "green" : "red" }}
          >
            <span className="featuredMoneyRate">
              {Math.round(porder * 100) / 100}%
            </span>
        ...
        <div className="d-flex justify-content-between align-items-center">
          <Link to="/orders" className="text-decoration-none">
            <span className="featuredSub">See all orders</span>
          </Link>
          <div
            style={{
      ...
      <div className="featuredItem">
        ...
        <div className="featuredMoneyContainer">
          ...
          <div
            className="d-flex align-items-center"
            style={{ color: pexpense >= 0 ? "green" : "red" }}
          >
            <span className="featuredMoneyRate">
              {Math.round(pexpense * 100) / 100}%
            </span>
        ...
        <div className="d-flex justify-content-between align-items-center">
          <Link to="/expenses" className="text-decoration-none">
            <span className="featuredSub">See all expenses</span>
          </Link>
          <div
            style={{
