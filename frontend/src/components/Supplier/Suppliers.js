...
function Suppliers() {
  ...
  const getSuppliers = async (sv, sc, so, scv) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_suppliers`,
      {
        method: "POST",
        headers: {
  ...
  const deleteSupplier = async (id) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/delete_supplier`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  const updateSupplier = async () => {
    ...
    let response = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/update_supplier`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
