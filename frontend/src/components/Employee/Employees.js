...
function Employees() {
  ...
  const getEmployees = async (sv, sc, so, scv) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_employees`,
      {
        method: "POST",
        headers: {
  ...
  const deleteEmployee = async (id) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/delete_employee`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  const updateEmployee = async () => {
    ...
    let response = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/update_employee`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
