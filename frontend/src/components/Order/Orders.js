...
function Orders() {
  ...
  const getOrders = async (sv, sc, so, scv) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_orders`,
      {
        method: "POST",
        headers: {
  ...
  const deleteOrder = async (id) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/delete_order`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
                    ...
                    <>
                      <div className="form-group mb-2">
                        ...
                        <input
                          ...
                          type="text"
                          value={viewOrderDetails.order_ref}
                          readOnly
                        />
                      </div>
                      <div className="form-group mb-2">
                        ...
                        <input
                          className="my_form_control"
                          type="text"
                          value={viewOrderDetails.customer_name}
                          readOnly
                        />
                      </div>
                      <div className="form-group mb-2">
                        ...
                        <input
                          className="my_form_control"
                          type="text"
                          value={moment(viewOrderDetails.due_date).format(
                            "MMMM Do, YYYY"
                          )}
                          readOnly
                        />
                      ...
                      <div className="form-group mb-2">
                        ...
                        <input
                          className="my_form_control"
                          type="text"
                          value={viewOrderDetails.grand_total}
                          readOnly
                        />
                      </div>
                      <div className="form-group mb-2">
                        ...
                        <div className="p-2 border rounded">
                          ...
                          {productDetails.length > 0 &&
                            JSON.parse(viewOrderDetails.items).map(
                              (viewItem, ind) => {
