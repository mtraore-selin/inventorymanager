...
function Expenses() {
  ...
  const getExpenses = async (sv, sc, so, scv) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_expenses`,
      {
        method: "POST",
        headers: {
  ...
  const getProductsDetailsById = async (value) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_products_details_by_id`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  const deleteExpense = async (id) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/delete_expense`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
                    ...
                    <>
                      <div className="form-group mb-2">
                        ...
                        <input
                          ...
                          type="text"
                          value={viewExpenseDetails.expense_ref}
                          readOnly
                        />
                      </div>
                      <div className="form-group mb-2">
                        ...
                        <input
                          className="my_form_control"
                          type="text"
                          value={viewExpenseDetails.supplier_name}
                          readOnly
                        />
                      </div>
                      <div className="form-group mb-2">
                        ...
                        <input
                          className="my_form_control"
                          type="text"
                          value={moment(viewExpenseDetails.due_date).format(
                            "MMMM Do, YYYY"
                          )}
                          readOnly
                        />
                      ...
                      <div className="form-group mb-2">
                        ...
                        <input
                          className="my_form_control"
                          type="text"
                          value={viewExpenseDetails.grand_total}
                          readOnly
                        />
                      </div>
                      <div className="form-group mb-2">
                        <label className="fst-italic fw-bold mb-2">
                          Item Details:
                        </label>
                        <div className="p-2 border rounded">
                          <div className="mb-2 row gx-0">
                            <div
                              className="fw-bold text-secondary col-2 d-flex align-items-center text-uppercase justify-content-center"
                              style={{ fontSize: "smaller" }}
                            >
                              Image
                            </div>
                            <div
                              className="fw-bold text-secondary col-4 d-flex align-items-center text-uppercase justify-content-start"
                              style={{ fontSize: "smaller" }}
                            >
                              Product Name
                            </div>
                          ...
                          {productDetails.length > 0 &&
                            JSON.parse(viewExpenseDetails.items).map(
                              (viewItem, ind) => {
                                let img = productDetails.find(
                                  (x) => x.product_id === viewItem.product_id
                                ).image;
                                return (
                                  <div
                                    key={ind}
                                    className="py-2 row gx-0"
                                    style={{
                                  ...
                                  >
                                        ...
                                        overlay={
                                          ...
                                          >
                                            ...
                                            >
                                              {img === null ? (
                                                <div
                                                  className="d-flex align-items-center text-dark fs-5 text-center"
                                                  style={{
                                                    width: "10rem",
                                                    height: "10rem",
                                                  }}
                                                ...
                                                <img
                                                  ...
                                                  src={`${process.env.REACT_APP_BACKEND_ORIGIN}/uploads/${img}`}
                                                  alt="product"
                                                />
                                              )}
                                            </Popover.Body>
                                    ...
                                    <div className="col-2 d-flex align-items-center justify-content-center">
                                      {viewItem.rate * viewItem.quantity}
                                    </div>
                                  </div>
                                );
                              }
