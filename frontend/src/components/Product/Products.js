...
function Products() {
  ...
  const getProducts = async (sv, sc, so, scv) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_products`,
      {
        method: "POST",
        headers: {
  ...
  const deleteProduct = async (id) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/delete_product`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  const deleteImage = async (id) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/delete_product_image`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  const updateProduct = async () => {
    ...
    let response = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/update_product`,
      {
        method: "POST",
        body: f,
        credentials: "include",
              ...
              <div className="card my_card" style={{ flex: 1 }}>
                <div className="card-body d-flex flex-column align-items-center">
                  {editOldImage !== null ? (
                    <>
                      <img
                        src={`${process.env.REACT_APP_BACKEND_ORIGIN}/uploads/${editOldImage}`}
                        alt="product_image"
                        className="rounded"
                        style={{
                          width: "90%",
                          margin: "15px",
                          border: "1px #89c878 solid",
                        }}
                      />
                      <button
