...
function Customer() {
  ...
  const getCustomers = async (sv, sc, so, scv) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_customers`,
      {
        method: "POST",
        headers: {
  ...
  const deleteCustomer = async (id) => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/delete_customer`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
  ...
  const updateCustomer = async () => {
    ...
    let response = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/update_customer`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json; charset=UTF-8",
