  ...
  getExpenses = (req, res) => {
    try {
      ...
      new Promise((resolve, reject) => {
        ...
        let q =
          "SELECT e.*, s.name as supplier_name FROM expenses e LEFT JOIN suppliers s ON e.supplier_id=s.supplier_id " +
          tsa +
          tso +
          " LIMIT ?, 10";
        db.query(q, [req.body.start_value], (err, result) => {
          ...
          if (req.body.search_value != "") {
            return resolve({
              operation: "success",
              message: "search expenses got",
              info: { expenses: result, count: result.length },
            });
          }
          ...
          db.query(q, (err, result2) => {
            ...
            resolve({
              operation: "success",
              message: "10 expenses got",
              info: { expenses: result, count: result2[0].val },
            });
          });
        });
      })
